...
import 'package:travel_assign/features/experience_details/bloc/experience_details_cubit.dart';
import 'package:travel_assign/features/experience_details/bloc/experience_details_state.dart';
import 'package:travel_assign/features/experience_details/view/widgets/experience_details_header.dart';
import 'package:travel_assign/features/experience_details/view/widgets/interests_row.dart';
...
class ExperienceDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _ExperienceDetailScreen(id: id),
    );
  }
}
...
class _ExperienceDetailScreen extends StatefulWidget {
  final String id;
  const _ExperienceDetailScreen({required this.id});
...
class _ExperienceDetailScreenState extends State<_ExperienceDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ExperienceDetailsCubit, ExperienceDetailsState>(
              ...
              body: SingleChildScrollView(
                child: Stack(
                  children: [
                    Stack(
                      children: [
                        AppCarousel(imageUrls: data.imageUrls ?? [], height: heightBgImage, firstImageHeroTag: data.id),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Spacer(),
                              CircularHeart(id: data.id ?? "", isSelected: data.isSaved, onToggle: (isSaved) {}),
                            ],
                          ),
                        ),
                      ],
